...
const classes = computed(() => {
    return props.active
        ? 'inline-flex items-center px-1 pt-1 border-b-2 border-red-100 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-red-100 transition'
